...
public:
    ...
    virtual bool definitely_supports_playback(String const& container, String const& media_types, Optional<Utf16String> encryption_scheme, Utf16String const& robustness, Bindings::MediaKeySystemConfiguration const& accumulated_configuration, MediaKeyRestrictions const& restrictions) const = 0;
...
public:
    ...
    virtual bool supports_init_data_type(Utf16String const& init_data_type) const override
    {
        ...
        constexpr Array<StringView, 1> registered_init_data_types = {
            "keyids"sv,
        };
    ...
    virtual bool definitely_supports_playback(String const& container, String const& media_types, Optional<Utf16String> encryption_scheme, Utf16String const& robustness, Bindings::MediaKeySystemConfiguration const& accumulated_configuration, MediaKeyRestrictions const& restrictions) const override
    {
        (void)container;
        (void)media_types;
